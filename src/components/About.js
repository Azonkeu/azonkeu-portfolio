...
const About = () => {
  return (
    ...
    >
      <div
        className="container mx-auto flex px-10 md:flex-row flex-col items-center"
        style={{
          maxWidth: '100%'
        }}
      >
        <div
          className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-0 md:mb-0 items-center text-center"
          style={{
            maxWidth: '100%'
          }}
        >
          ...
          <div className="flex justify-center text-white">
            ...
            <a
              href="http://www.keepandshare.com/doc19/view.php?id=39888&da=y" target="_blank"
